...
import { ArrowLeft, TrendingUp, TrendingDown, BarChart3, PieChart, Activity, Calendar, Download, RefreshCw, Bug, FileCode, Shield, Zap, AlertTriangle, CheckCircle } from 'lucide-react';
...
export default function AnalyticsPage() {
  ...
  const severityBreakdown = [
    ...
    { severity: 'Medium', count: 498, color: 'text-yellow-400 bg-yellow-500/20' },
  ...
  const maxTrendValue = Math.max(...weeklyTrend.map(w => Math.max(w.bugs, w.reviews)));
