...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      {/* Sidebar */}
      <aside
        className={`${sidebarOpen ? "w-64" : "w-20"} bg-black/40 backdrop-blur-xl border-r border-white/10 transition-all duration-300 flex flex-col`}
      >
        {/* Logo & Toggle */}
        ...
        <div className="p-4 border-t border-white/10">
          <div
            className={`flex items-center gap-3 p-3 rounded-xl bg-white/5 ${sidebarOpen ? "" : "justify-center"}`}
          >
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20 p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <button
                    onClick={() => handleQuickAction("bug-analyzer")}
